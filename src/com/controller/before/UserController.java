...
public class UserController {
	...
	public String editPwd(@ModelAttribute Buser buser,Model model, HttpSession session, String code,String nbpwd) {
		return userService.editPwd(buser, model, session, code,nbpwd);
	}
}
