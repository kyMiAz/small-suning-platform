...
<script type="text/javascript">
			//确定按钮
			function gogo(){
				var bpwd = document.payForm.bpwd.value;
				var pwd = "${bruser.bpwd}"
				console.log(pwd);
				if(bpwd==pwd){
...
<style>
    ...
    .pay{
    	...
    	color: #FFF;
    	display: inline-block;
    	background: linear-gradient(to bottom right, #70b9ff, #39F);
...
<body>
	...
	<div class="location ared">当前位置：<a href="before">首页</a> > 购物流程 > 生成订单</div>
	<div class="blank"></div>
	<div class="nFlowBox">
    <h2 style="text-align:center; height:30px; line-height:30px;">感谢您在本站购物！您的订单已提交成功，
         	请记住您的订单号: <font style="color:red" size='5'>${ordersn}</font>
    </h2><br/>
      <center>
      <form action="order/pay" method="post" name="payForm">
            	<input type="hidden" name="ordersn" value="${ordersn}"/>
            	<span style="font-size:15px">请输入账户密码：</span>
            	<input type="password" name="bpwd" /><br>
            	<div class="blank"></div>
            	<a class="pay" href="javascript:void(0);" onclick="gogo()">支付</a>
            	<br>
            	<div class="blank20"></div>
            	<img src="images/before/Chinapay_logo.jpg">
      </form>
      </center>
    </div>
    </div>
