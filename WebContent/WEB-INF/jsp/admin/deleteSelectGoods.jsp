	...
	<script type="text/javascript">
  		...
  		function checkDel(id){
  			if(window.confirm("是否删除该商品？")){
  				window.location.href = "/ch20/adminGoods/deleteAGoods?act=deleteSelect&id="+id;
  			}
  		}
  </script>
</head>
<body>
	<font size=6 face=华文新魏  style="padding-left:350px">删除商品</font>
		...
		<table border="1" bordercolor="black">
			...
			<tr style="height:20px;">
				<td colspan="6" style="height:20px;">
					<input class="deleteinp" type="button" value="删除" onclick="confirmDelete()">
				</td>
			</tr>
			<tr>
